...
public class BookManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:h2:mem:test", "ben", "stokes");
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    break;
                // DISPLAY BOOKS BY TITLE PATTERN
                case 3:
        ...
        try {
            ...
            while (rs.next()) {
                System.out.println(
                        ...
                        + ", Year of publication = " + rs.getInt("publicationYear"));
            }
            rs.close();
            st.close();
        } catch (Exception e) {
    ...
    static void updateCopies(Connection con, Scanner sc) {
        ...
        try {
            ...
            PreparedStatement ps =
                    con.prepareStatement("UPDATE Book SET copiesAvailable=? WHERE bookId=?");
