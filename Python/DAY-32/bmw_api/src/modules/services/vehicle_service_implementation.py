...
class VehicleServiceImpl(VehicleService):
    ...
    async def get_vehicle_by_id(self, vehicle_id: int) -> VehicleResponse:
        vehicle = await self.vehicle_repository.get_vehicle_by_id(vehicle_id)
    ...
    async def create_vehicle(self, vehicle_request: VehicleRequest) -> VehicleResponse:
        vehicle = await self.vehicle_repository.create_vehicle(vehicle_request)
        return VehicleResponse(
            id=vehicle.id,
            make=vehicle.make,
            model=vehicle.model,
    ...
    async def update_vehicle(self, vehicle_id: int, vehicle_data: VehicleRequest) -> VehicleResponse:
        vehicle = await self.vehicle_repository.update_vehicle(vehicle_id, vehicle_data)
        return VehicleResponse(
            id=vehicle.id,
            make=vehicle.make,
            model=vehicle.model,
    ...
    async def delete_vehicle(self, vehicle_id: int) -> bool:
        return await self.vehicle_repository.delete_vehicle(vehicle_id)