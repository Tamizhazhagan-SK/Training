...
from modules.services.vehicle_service_implementation import VehicleServiceImpl
...
async def create_vehicle(vehicle_data: VehicleRequest) -> VehicleResponse:
...
async def update_vehicle(vehicle_id: int, vehicle_data: VehicleRequest) -> VehicleResponse:
    return await vehicleService.update_vehicle(vehicle_id, vehicle_data)


@router.delete("/{vehicle_id}")
async def delete_vehicle(vehicle_id: int) -> dict:
    result = await vehicleService.delete_vehicle(vehicle_id)
    if result:
